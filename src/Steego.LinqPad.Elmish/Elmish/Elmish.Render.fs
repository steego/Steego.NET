module Steego.LinqPad.Elmish.Render
...
let internal unitlessCssProps = HashSet ["animation-iteration-count"; "border-image-outset"; "border-image-slice"; "border-image-width"; "box-flex"; "box-flex-group"; "box-ordinal-group"; "column-count"; "columns"; "flex"; "flex-grow"; "flex-positive"; "flex-shrink"; "flex-negative"; "flex-order"; "grid-row"; "grid-row-end"; "grid-row-span"; "grid-row-start"; "grid-column"; "grid-column-end"; "grid-column-span"; "grid-column-start"; "font-weight"; "line-height"; "opacity"; "order"; "orphans"; "tab-size"; "widows"; "z-index"; "zoom"; "-webkit-line-clamp"; "fill-opacity"; "flood-opacity"; "stop-opacity"; "stroke-dasharray"; "stroke-dashoffset"; "stroke-miterlimit"; "stroke-opacity"; "stroke-width"]

let internal voidTags = HashSet ["area"; "base"; "br"; "col"; "embed"; "hr"; "img"; "input"; "keygen"; "link"; "menuitem"; "meta"; "param"; "source"; "track"; "wbr"]


let internal renderCssProp (html:TextWriter) (prop: CSSProp) =
  match prop with
...
let internal renderSVGAttr (html:TextWriter) (attr: SVGAttr) =
  match attr with
...
let internal renderHtmlAttr (html:TextWriter) (attr: HTMLAttr) =
  match attr with
...
let internal renderAttrs (html:TextWriter) (attrs: IProp seq) tag =
